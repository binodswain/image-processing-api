...
import { createThumbnail, getFullImage, getImageList, getThumbnail, getThumbnailList } from '../helpers/storage';
import { validateQueryFilename, validateQueryParam } from '../middleware/validator';
 ...
 */
routes.get('/images', validateQueryParam, validateQueryFilename, async (req: express.Request, res: express.Response): Promise<express.Response<string> | void> => {
    try {
